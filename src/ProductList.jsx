...
// Calculate total amount for all products in the cart
  ...
  const no_of_items = noofitemsincart();
    ...
    <div key={index}>
        ...
        <div className="product-list">
            ...
            <div className="product-card" key={plantIndex}>
                ...
                <button  
                className={addedToCart[plant.name] ? ` product-button added-to-cart` : `product-button`} onClick={() => handleAddToCart(plant)}>
